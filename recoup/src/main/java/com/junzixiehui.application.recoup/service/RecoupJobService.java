...
public class RecoupJobService {
     ...
     */
    public void saveRecoupJob(RecoupJob recoupJob) {
        ...
        recoupJobEntity.setUpdateTime(DateUtils.formatNow2Long());
